(function () {
    ...
    var devices = [
        { name: 'Apple iPhone 5',           height: 320,  width: 568,  ratio: 2,        safeAreaRatio: 0},
        { name: 'Apple iPhone 6',           height: 375,  width: 667,  ratio: 2,        safeAreaRatio: 0},
        { name: 'Apple iPhone 6 Plus',      height: 414,  width: 736,  ratio: 3,        safeAreaRatio: 0},
        { name: 'Apple iPhone 7',           height: 375,  width: 667,  ratio: 2,        safeAreaRatio: 0},
        { name: 'Apple iPhone 7 Plus',      height: 414,  width: 736,  ratio: 3,        safeAreaRatio: 0},
        { name: 'Apple iPhone X',           height: 375,  width: 812,  ratio: 3,        safeAreaRatio: 0.054187192 },

        { name: 'Apple iPad',               height: 768,  width: 1024, ratio: 2,        safeAreaRatio: 0},
        { name: 'Apple iPad Air 2',         height: 768,  width: 1024, ratio: 2,        safeAreaRatio: 0},
        { name: 'Apple iPad Pro 10.5-inch', height: 834,  width: 1112, ratio: 2,        safeAreaRatio: 0},
        { name: 'Apple iPad Pro 12.9-inch', height: 1024, width: 1366, ratio: 2,        safeAreaRatio: 0},

        { name: 'Huawei P9',                height: 540,  width: 960,  ratio: 2,        safeAreaRatio: 0},
        { name: 'Huawei Mate9 Pro',         height: 720,  width: 1280, ratio: 2,        safeAreaRatio: 0},

        { name: 'Xiaomi 10 Pro',            height: 540,  width: 1170, ratio: 2,        safeAreaRatio: 0.054187192 },

        { name: 'Goolge Nexus 5',           height: 360,  width: 640,  ratio: 3,        safeAreaRatio: 0},
        { name: 'Goolge Nexus 5X',          height: 411,  width: 731,  ratio: 2.625,    safeAreaRatio: 0},
        { name: 'Goolge Nexus 6',           height: 412,  width: 732,  ratio: 3.5,      safeAreaRatio: 0},
        { name: 'Goolge Nexus 7',           height: 960,  width: 600,  ratio: 2,        safeAreaRatio: 0},
    ];
    ...
    function onload () {
        ...
        function updateResolution () {
            ...
            window.safeAreaRatio = size.safeAreaRatio;
